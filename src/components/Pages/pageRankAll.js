...
class PageRankAll extends Component {
                    ...
                    <div className="comic-list-container">
                        <section className="left-side-item ">
                            <div className="introduction-item introduction-item-1">
                                <h3 className="page-title">Top All <i className="fa fa-angle-right" /></h3>
                            </div>
                            {listStoryHot}
                        </section>
                        <MainBetweenRight />
...
export default connect(mapStateToProps, mapDispatchToProps)(PageRankAll)
