        ...
        return (
            <div id="nextBar" className="navMenu" style={{ width: '66%', marginLeft: '5%' }}>
                <ul className=''>
                    ...
                    <li><a href='/' title="Hiện kết quả 145 tới 180 / 18540">5</a> </li>
                    <li className="PagerSSCCells"><a href='/' title="Hiện kết quả 3205 tới 3240 / 18540">90</a> </li>
                    ...
                    <li className="PagerSSCCells"><a href='/' title="Hiện kết quả 15445 tới 15480 / 18540">430</a> </li>
